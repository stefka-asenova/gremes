...
For large graphs this will be not so handy. Below there are some tools to create subsets automaticaly that satisfy the first two recommendations above.

## Creating subsets on the priciple of **neighborhood**.
