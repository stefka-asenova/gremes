...
Consult Vignettes **Application Danube** and **Application Seine** for two case studies - one without unobserved variables and one with unobserved variables respectively.
...
- `MLE`, `MLE1`, `MLE2` provide maximum Likelihood estimates and are based on the asymptotics in 1. See Vignettes "Estimation - Note 2" and "Code - Note 2".
