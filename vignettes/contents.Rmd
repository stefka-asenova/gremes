...
- computes cliquewise estimator by @engelke2020 based on an asypmtotic result about $(X/t)\mid \max_{v\in V}X_v>t$ - use method `estimate.MME`; applicable when there are latent variables.
