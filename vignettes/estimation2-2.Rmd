...
Consider the likelihood function of a random sample $y_{i}, i=1, \ldots, k$ of mulivariate normal distribution with mean vector $\mu$ and covariance matrix $\Sigma$, where $y_i$ is of dimension $d$.
