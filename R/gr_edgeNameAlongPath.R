...
#' @rdname edge_names_along_path
#' @export
#' @param obj object of class \code{HRMnetwork}
#' @param rt the name of the node from which the path is requested
#' @param id The name of the node to which the path is requested
#' @param edge_names Returns a vector with the names of the edges. Default is TRUE. If FALSE, it returns
